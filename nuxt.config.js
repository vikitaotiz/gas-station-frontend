...
plugins: [
  ...
  { src: '~/plugins/NotificationKitchen.js', ssr: false },
  { src: '~/plugins/NotificationBarista.js', ssr: false }
],
...
env: {
  // WS_URL: process.env.WS_URL || 'https://pos.overseasguruconsultant.co.ke/'
...
axios: {
  // baseURL: 'https://posback.overseasguruconsultant.co.ke/api'
